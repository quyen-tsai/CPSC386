...
class Scoreboard():
    ...
    def prep_ships(self):
        for ship_number in range(self.stats.ships_left):
            ship = Ship(self.settings, self.screen, ship_sheet = 'Images/ship_spritesheet.png')
            ship.rect.x = 10 + ship_number * ship.rect.width
            ship.rect.y = 10
            self.ships.append(ship)

    def update_score(self, update_score):
        self.stats.score += update_score
    ...
    def show_score(self):
        pygame.draw.rect(self.screen, (0, 0, 0), ((0, 0), (self.screen_rect.width, self.level_rect.bottom + 10)))
